    ...
    <div class="swiper-container" id="cont">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="http://statics.zhuishushenqi.com/recommendPage/154106329634833" alt="">
        </div>
        <div class="swiper-slide">
           <img src="http://statics.zhuishushenqi.com/recommendPage/154106331341189" alt="">
        </div>
        <div class="swiper-slide">
           <img src="http://statics.zhuishushenqi.com/recommendPage/154043150879037" alt="">
        </div>
      </div>
    </div>
    <!-- 路由导航条 -->
...
.select{
  ...
  .nav{
    ...
    span .icon{
        background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADwAAAA8CAYAAAA6/NlyAAAAGXRFW…xSMdpYJTyKR3UZKjtqOcEkZaVqHEX7RgTldHE9ivd/AQYAqHW4gFquh+QAAAAASUVORK5CYII=) no-repeat;
      }
    }
  }
  .line{
